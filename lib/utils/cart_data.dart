        ...
        try {
          ...
          if (data["error"] != "true") {
            ...
            if (data["items"] != "Cart is Empty") {
              ...
              print(rest);
              List<CartItemModal> itemList = rest
                  .map<CartItemModal>((json) => CartItemModal.fromJson(json))
                  .toList();
  ...
  Future<double> calculateTotalPrice() async {
    ...
    if (list.length > 0) {
      for (int i = 0; i < list.length; i++) {
        print(i.toString() +
            " " +
            list[i].ourPrice.toString() +
            " " +
            itemListProduct[list[i]].toString());
...
class CartItemModal {
  ...
  CartItemModal({this.upcCode, this.qty, this.itemName});
